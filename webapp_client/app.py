...
file_directory="/Users/sumitkumar/Desktop/sumit_dir/Project_17_oct_23/vivek_sir_work/sumit "
...
def generate_html_file_answer_list(csv_file_name, answer_data_list):
    ...
    for item in answer_data_list:
        ...
        answer = item[1].strip('"') if len(item) > 1 else ""
        html_table_answer_list += f""" 
                            <tr>
                                ...
                                <td style="width: 25%;">
                                    <input type="text" name="{question}" value="{answer}" oninput="change_boder_color(event)" style="width:70%">
                                </td>
                                </tr>
                            """
...
def update_csv_file(file_name: str)-> str:
    ...
    if request_type:
        ...
        return generate_html_file_answer_list(file_name, data)
        # if csv_writer:
        #     return "<div style='text-align:center; margin-top:20%'> This file has been updated successfully. Go to <a href='http://127.0.0.1:5000/files'>home</a></div>"
        # else:
